...
- [ ] Support GitHub App authentication in addition to personal access tokens?
- [ ] Implement encryption for stored tokens in config files?
- [ ] Support multiple GitHub accounts/tokens?
